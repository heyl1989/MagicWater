...
public class GameActivity extends BaseActivity implements View.OnClickListener {
    ...
    private CustomView imgBottleTwo;
    private CustomView imgBottleOne;
    private CustomView imgBottleThree;
...
//        frameAnimation.start();
        ...
        //第一个瓶子
        imgBottleOne = (CustomView) findViewById(R.id.cv_bottle_one);
        ...
        //第二个瓶子
        imgBottleTwo = (CustomView) findViewById(R.id.cv_bottle_two);
        ...
        //第三个瓶子
        imgBottleThree = (CustomView) findViewById(R.id.cv_bottle_three);
    ...
    private void initData() {
        ...
        imgBottleOne.setVisibility(View.VISIBLE);
        tvBottleOne.setText("");
    ...
    public void getPosition(BusEventData data) {
        //操作的是第一个瓶子
        if (data.getCustomView().equals(imgBottleOne)) {
            imgBottleOne.bringToFront();
        ...
        //操作的是第二个瓶子
        if (data.getCustomView().equals(imgBottleTwo)) {
            imgBottleTwo.bringToFront();
        ...
        //操作的是第三个瓶子
        if (data.getCustomView().equals(imgBottleThree)) {
            imgBottleThree.bringToFront();
